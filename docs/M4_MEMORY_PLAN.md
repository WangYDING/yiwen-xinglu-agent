...
- **当前状态**：M4-P0、M4-P1、M4-P2、M4-P3、M4-P4 与退出审计均已完成；M5 尚未开始
...
| **M4 退出审计（已完成）** | P1–P4 已提交证据 | `M4_EXIT_AUDIT.md`、能力边界、已知限制和最终结论 | 顺手修功能、真实供应商扩权、M5 代码 | 全量与专项测试、Gold、重建、安全检查和文档一致；真实 Embedding 明确未验证 | 不需要；实际外部请求和费用为 0 | 证据与实现不一致时停止，不能靠审计修改代码掩盖缺口 |
...
4. 是否单独增加真实 Embedding 小型 Pilot。M4 已按离线工程契约完成退出；真实 Pilot 不是 M4-P0–P4 的隐式授权。
