...
> **当前更新（2026-08-10）**：P2 旧 15 条已转为观察开发集；P2c 已冻结 `retrieval_query_v2`、`embedding_document_v2`、保守策略契约及 36 条新 holdout，但没有运行 BGE。下一次只允许一组两次本地正式验证；未通过时关闭 Dense-only 优化，不自动扩展 reranker 或其他模型。M4 保持完成，P3 与 M5 尚未开始。

## 1. 文档身份

- **状态**：M4.5-P0/P1/P2a 已完成；P2 两次正式本地运行已完成但语义质量未通过；P3 未开始
