...
| M5：三病例游戏纵向切片 | 已完成 | 三病例、确定性跨案连续性、可见成长、安全 Agent 工具、持久化恢复和普通用户 CLI 形成完整本地纵向切片 |
...
| M6-P3：两类岗位求职材料 | 未开始 | 简历描述、项目讲解和面试问答尚未制作 |
| M6-P4：最终发布检查 | 未开始 | 只有用户明确授权后才允许创建远程、推送、Tag、Release 或发布 |
| M6 之外 | 未开始 | 自适应教学、Reflection、网页、多 Agent 和新玩法不属于发布准备范围 |
