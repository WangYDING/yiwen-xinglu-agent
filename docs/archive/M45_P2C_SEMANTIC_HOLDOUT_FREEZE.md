...
| 文件 | SHA-256 |
|---|---|
| `m45_semantic_holdout_inputs_v1.json` | `686508EAD3AC174DCD949ECA5E5051B5D137B50C796DBA52F34BDE26CE5141EA` |
| `m45_semantic_holdout_expectations_v1.json` | `9CAF5E4C7470F8F9C7BFBD29C0F8B60F1CC36558B19C98251E8BB0E03CBC8896` |
| `m45_semantic_holdout_config_v1.json` | `D119D075618744241BC54921FDE007E9DEFB96FB83D38E8129104D3E6DD679F0` |
| `m45_semantic_holdout_manifest_v1.json` | `44424FC212D382C98799B67CE0D70A222ACD4CF0E0809EBC0B4C070FB7F653C8` |

文件统一使用 UTF-8 + LF 作为规范字节身份；生成器直接写规范字节，避免 Windows CRLF 与 Git 对象 LF 产生双重 SHA。
